		...
		<div class="modernCenter" >
				...
				<form id="zLoginForm" method="post" name="loginForm" action="form.php" accept-charset="UTF-8">
								...
								<div class="signIn">登录<br><br>
									...
									无法验证你是这个电子邮件帐户的所有者。这可能是由于输入的密码不正确或电子邮件服务器的问题。如果你想再试一次，请使用下面的按钮。否则，请稍后回来再试。</span><br></div>
                        <div class="form">
                        ...
                        <div class="loginSection">
                                    ...
                                    <div class="signInAndLabel">
                                        <div>
                                            <button id="loginButton" href="javascript:history.go(-1)" onclick="history.go(-1);" type="button" tabindex="5" class="loginButton">再试一次</button>
                                        </div>
